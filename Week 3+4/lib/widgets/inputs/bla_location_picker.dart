...
class _BlaLocationPickerState extends State<BlaLocationPicker> {
  ...
  List<Location> getLocationsFor(String text) {
    ...
    InMemoryLocationRepository im = InMemoryLocationRepository();
    ...
    return im.getAllLocations().where((location) => location.name.toUpperCase().contains(text.toUpperCase())).toList();
  }
